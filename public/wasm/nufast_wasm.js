...
export class OscParams {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        OscParamsFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_oscparams_free(ptr, 0);
    }
    /**
     * @param {number} theta12_deg
     * @param {number} theta13_deg
     * @param {number} theta23_deg
     * @param {number} delta_cp_deg
     * @param {number} dm21sq
     * @param {number} dm31sq
     * @param {boolean} matter
     * @param {number} rho
     * @param {number} ye
     * @param {boolean} anti
     */
    constructor(theta12_deg, theta13_deg, theta23_deg, delta_cp_deg, dm21sq, dm31sq, matter, rho, ye, anti) {
        const ret = wasm.oscparams_new(theta12_deg, theta13_deg, theta23_deg, delta_cp_deg, dm21sq, dm31sq, matter, rho, ye, anti);
 ...
 * @returns {Float64Array}
 */
export function calculate_energy_spectrum(params, l, initial_flavor, e_min, e_max, num_points) {
    _assertClass(params, OscParams);
    const ret = wasm.calculate_energy_spectrum(params.__wbg_ptr, l, initial_flavor, e_min, e_max, num_points);
    var v1 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 8, 8);
    return v1;
}
 ...
 * @returns {Float64Array}
 */
export function get_probabilities(params, l, e, initial_flavor) {
    _assertClass(params, OscParams);
    const ret = wasm.get_probabilities(params.__wbg_ptr, l, e, initial_flavor);
    var v1 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 8, 8);
    return v1;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./nufast_wasm_bg.js": import0,
    };
}

const OscParamsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_oscparams_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nufast_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
